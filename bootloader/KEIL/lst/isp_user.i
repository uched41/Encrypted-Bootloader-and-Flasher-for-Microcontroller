...
__align(4) static uint8_t aprom_buf[0x800];
...
static uint16_t CalCheckSum(uint32_t start, uint32_t len)
{
    ...
    for(i = 0; i < len; i+=0x800) {
        ReadData(start + i, start + i + 0x800, (uint32_t*)aprom_buf);
        if(len - i >= 0x800)
            lcksum += Checksum(aprom_buf, 0x800);
        else
...
void EraseAP(unsigned int addr_start, unsigned int addr_end)
{
    ...
    for(; eraseLoop < addr_end; eraseLoop += 0x800 ) {
...
int ParseCmd(unsigned char *buffer, uint8_t len)
{
    ...
    if(lcmd == 0x000000A6) {
        ...
        (*((volatile unsigned int *)(response + 8))=(((SYS_T *) ((0x40000000UL) + 0x00000))->PDID));
        goto out;
    } else if(lcmd == 0x000000AB || lcmd == 0x000000AC || lcmd == 0x000000AD) {
        (*((volatile unsigned int *)(&((SYS_T *) ((0x40000000UL) + 0x00000))->RSTSTS))=(3));
         
        if(lcmd == 0x000000AB) {
            i = (((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL & 0xFFFFFFFC);
        } else if(lcmd == 0x000000AC) {
            i = (((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL & 0xFFFFFFFC);
            i |= 0x00000002;
        } else {
            i = (((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL & 0xFFFFFFFE);
        }

        (*((volatile unsigned int *)(&((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL))=(i));
        ...
        EraseAP(0x00000000UL, g_dataFlashAddr); 
        ...
        (*((volatile unsigned int *)(response + 8))=((((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL&0x2)? 2 : 1));
    }
    ...
    if((lcmd == 0x000000A0) || (lcmd == 0x000000C3)) {
        ...
        if((StartAddress%0x800) >= (0x800-LastDataLen))
            FMC_Erase_User((StartAddress & 0xFFE00)+0x800);
        goto out;
