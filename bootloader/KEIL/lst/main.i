...
__align(4) uint8_t  uart_rcvbuf[16];				
...
static void SYS_Init(void)
{
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL |= ((0x1ul << (2)) | (0x1ul << (0)));

     
    while(!(((CLK_T *) ((0x40000000UL) + 0x00200))->STATUS & (0x1ul << (4))));
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 |= (((1)-1) << (0));
    ...
    while(!(((CLK_T *) ((0x40000000UL) + 0x00200))->STATUS & (0x1ul << (2))));
    
    
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 & (~(0x7ul << (0)))) | (0x02UL<<(0));

     
    PllClock        = 71884880;            
    SystemCoreClock = 71884880 / 1;        
    CyclesPerUs     = 71884880 / 1000000;  

     
    ((CLK_T *) ((0x40000000UL) + 0x00200))->APBCLK0 |= (0x1ul << (16));

     
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL1 &= ~(0x3ul << (24));
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL1 |= (0x3UL<<(24));
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 &= ~(0xful << (8));
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 |= (((1)-1) << (8));
...
void UART0_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->INTSTS;

    if(u32IntSrc & 0x11) { 
        while(((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->FIFOSTS & (0x1ul << (14))) == 0) && (bufhead < 16))	
            uart_rcvbuf[bufhead++] = ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->DAT;
    }
...
static void UART0_Init()
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000))->IPRST1 |=  (0x1ul << (16));
    ((SYS_T *) ((0x40000000UL) + 0x00000))->IPRST1 &= ~(0x1ul << (16));

     
    ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->BAUD = ((0x1ul << (29)) | (0x1ul << (28))) | (((((22118400UL)) + ((115200)/2)) / (115200))-2);
    ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->LINE = (3) | (0x0 << (3)) | (0x0 << (2));

     
    ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->FIFO = (((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->FIFO & (~(0xful << (16)))) | (0x3 << (16));

     
    ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->FIFO = (((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->FIFO & (~(0xful << (4)))) | (0x3 << (4));

     
    ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->INTEN |= ((0x1ul << (0)) | (0x1ul << (4)));

     
    ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->TOUT = (((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->TOUT & ~(0xfful << (0))) | (0x3E);
    ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->INTEN |= (0x1ul << (11));
...
static uint8_t toApplication(void )
{
	...
	(*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(1))) + ((10)<<2)))) = 1;
	...
	return (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(1))) + ((10)<<2))));
}
...
{
	(*((volatile unsigned int *)(&((SYS_T *) ((0x40000000UL) + 0x00000))->RSTSTS))=(3));
	
	
	(*((volatile unsigned int *)(&((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL))=((*((volatile unsigned int *)(&((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL))) & 0xFFFFFFFC));		
...
static void replyPC(uint8_t* msg)
{
	...
	for(i=0; i<16; i++)
	{
		...
		((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->DAT = msg[i]; CLK_SysTickDelay(10);
	}
...
int main(void)
{
	...
	SYS_UnlockReg();
	((WDT_T *) (((0x40000000UL) + 0x00040000) + 0x00000))->CTL &= ~(0x1ul << (7));		
	SYS_Init();
	...
	((GPIO_T *) ((0x40000000UL) + 0x04040))->MODE |= (0b0011 << (10*2));
  ...
  GetDataFlashInfo(&g_dataFlashAddr , &g_dataFlashSize);
	...
	while(1)
	{
		...
		if(bUartDataReady)
		{
			...
			AES_CBC_decrypt_buffer(&ctxMCU, uart_rcvbuf, 16);		
